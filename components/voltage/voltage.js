...
export default class App extends Component {
    ...
    getChartData = async (callback) => {
        ...
        try {
            ...
            fetch(`https://apiv1.zis.ru/tests/avg_data/${id}?date_begin=${date_begin}&date_end=${date_end}&period=${chart_type}&data_type=voltage`, {
                method: 'GET',
                headers: {
                            ...
                            <View style={styles.impulse_surges_item_img_dates_info_wrapper}>
                                          ...
                                          <script type="text/javascript">
                                                document.addEventListener("message", message => {
                                                  ...
                                                  const translateChart = {
                                                      ...
                                                      chartValue: { en: 'voltage', ru: 'Напряжение' },      
                                                   };
                                                  ...
                                                  function drawVisualization() {
                                                          ...
                                                          //   var showAs = 'days'; //показывать как hourly | week | days
                                                           ...
                                                           if(chartData1.chart_type == 'day') {
                                                            ...
                                                            dataArray.push([
                                                                caption,  //Заголовок
                                                                (element.voltage == 0 ) ? null : element.voltage//Целевое значение
                                                            ]);
                                                    });
                                ...
                                <View style={styles.impulse_surges_items_second_wrapper}>
                                    ...
                                    <View style={styles.impulse_surges_item}>
                                        ...
                                        <Text style={styles.impulse_surges_item_info}>{parseFloat(this.state.minimum_info).toFixed(1)} {this.state.language.voltage_n}</Text>
                                    </View>
                                    <View style={styles.impulse_surges_item}>
                                        <Text style={styles.impulse_surges_item_title}> {this.state.language.maximum}</Text>
                                        <Text style={styles.impulse_surges_item_info}>{parseFloat(this.state.maximum_info).toFixed(1)} {this.state.language.voltage_n}</Text>
                                    </View>
                                    <View style={styles.impulse_surges_item}>
                                        <Text style={styles.impulse_surges_item_title}> {this.state.language.average}</Text>
                                        <Text style={styles.impulse_surges_item_info}>{parseFloat(this.state.voltage_item_info).toFixed(1)} {this.state.language.voltage_n}</Text>
                                    </View>
                                </View>
