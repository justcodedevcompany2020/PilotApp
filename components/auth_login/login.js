...
export default class App extends Component {
                ...
                if (response.hasOwnProperty('accessToken')) {
                    ...
                    if (response.hasOwnProperty('description')) {
                        ...
                        if (response.description.en == 'Account not found') {
                            error_text = this.state.language.account_not_found
                            this.setState({
                                email_error: true,
                                email_error_text: error_text,
                            })
                        ...
                        if (response.description.en == 'Invalid password') {
                            error_text = this.state.language.invalid_password
                            this.setState({
                                password_error: true,
                                password_error_text: error_text
                            })
   ...
   chooseLanguage = async (callback) => {
       ...
       let  {selectedLanguage} = this.state;
        console.log(selectedLanguage, 'aaaaaa')
            ...
            <SafeAreaView style={styles.container} >
                ...
                <ScrollView style={styles.login_main_wrapper}>
                    ...
                    <View style={[styles.login_input_field_wrapper, {flexDirection: 'row', alignItems: 'center' }]}>
                        <TextInput
                            style={[styles.login_input_field, {marginRight: 18, flex: 1}]}
                        ...
                        <TouchableOpacity style={styles.login_btn} onPress={() => {this.loginHandler()}}>
                            <Svg width={12} height={20} viewBox="0 0 12 20" fill="none" xmlns="http://www.w3.org/2000/svg">
                                <Path d="M1.406 19.266L0 17.859l8.297-8.226L0 1.406 1.406 0l9.633 9.633-9.633 9.633z" fill="#fff"/>
                            </Svg>
                        </TouchableOpacity>
                    ...
                    <View style={styles.login_buttons_wrapper}>
                         <TouchableOpacity style={styles.registration_btn} onPress={() => {this.redirectToRegistration()}}>
                             <Text style={styles.registration_btn_text}>{this.state.language.registration}</Text>
                         </TouchableOpacity>
