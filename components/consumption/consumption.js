...
export default class App extends Component {
    constructor(props) {
        ...
        this.state = {
            ...
            consumption_item_info: '75.5 kWh',
            todayDate: '',
                            ...
                            <View style={styles.impulse_surges_item_icon_title_wrapper}>
                                <View style={styles.impulse_surges_item_icon}>
                                    ...
                                    >
                                        ...
                                        <Path
                                            d="M5 9.714h3.675L7.397 14 13 8.286H9.325L10.6 4 5 9.714z"
                                            fill="#fff"
                                        />
                                    </Svg>
                                </View>
                                <Text style={styles.impulse_surges_item_info1}>{this.state.consumption_item_info}</Text>
                            </View>
