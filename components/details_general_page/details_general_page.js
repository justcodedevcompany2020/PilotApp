                                 ...
                                 <View style={styles.details_general_page_info_name_edit_btn_wrapper}>
                                     ...
                                     <TouchableOpacity style={styles.details_general_page_info_name_edit_btn} onPress={() => {this.setState({edit_name_popup: true})}}>
                                         <Svg
                                             ...
                                             xmlns="http://www.w3.org/2000/svg"
                                         >
                                             <G clipPath="url(#clip0_6_105)">
                                                 <Path
                                                     d="M8.745 1.62L7.38.255A.866.866 0 006.763 0a.867.867 0 00-.617.255L.433 5.97a.35.35 0 00-.1.2l-.33 2.433a.35.35 0 00.395.395l2.433-.33a.35.35 0 00.2-.1l5.714-5.713A.867.867 0 009 2.237a.866.866 0 00-.255-.617zM2.619 7.988L.76 8.24l.253-1.86L5.06 2.333 6.668 3.94 2.619 7.988zm5.63-5.63L7.164 3.443 5.557 1.837 6.642.75a.17.17 0 01.242 0L8.25 2.116a.17.17 0 010 .242z"
                                                     fill="#10BCCE"
                                                 />
                                             </G>
                                             <Defs>
                   ...
                   <View style={styles.edit_name_popup}>
                       <View style={styles.edit_name_popup_wrapper}>
                           <TouchableOpacity
                               ...
                               onPress={() => {
                                   this.setState({edit_name_popup: false})
                               }}>
                               <Svg
                                   width={25}
                                   height={25}
