...
export default class App extends Component {
    ...
    recoveryPassword = async () => {
        ...
        try {
            fetch(`https://apiv1.zis.ru/account/recovery`, {
                method: 'POST',
                headers: {
            ...
            <SafeAreaView style={styles.container} >
                ...
                <ScrollView style={styles.password_recovery_main_wrapper}>
                    ...
                    <Text style={styles.password_recovery_info}>
                        {this.state.language.password_recovery_page_text}
                    </Text>

                    <View style={[styles.password_recovery_input_field_wrapper, {flexDirection: 'row', alignItems: 'center' }]}>
                    ...
                    <View style={styles.password_recovery_buttons_wrapper}>
