...
export default class App extends Component {
    constructor(props) {
        ...
        this.state = {
            ...
            language: en,
            language_name: 'en',
            animatedValue: new Animated.Value(-windowWidth)
    ...
    closeMenu = async () => {
        ...
        await  Animated.timing(this.state.animatedValue, {
            toValue: -windowWidth,
            duration: 700,
            useNativeDriver: false,
        }).start()
                ...
                <View style={styles.header_menu_popup}>
                    ...
                    <View style={[styles.header_menu_popup_wrapper, {paddingBottom: Platform.OS === 'ios' ? 170 : 100}]}>
                        ...
                        <View style={styles.header_menu_popup_call_email_logo_wrapper}>
                            ...
                            <TouchableOpacity onPress={() => { Linking.openURL('https://zis.ru');}} style={styles.header_menu_popup_footer_logo}>
