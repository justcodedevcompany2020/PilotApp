            ...
            <SafeAreaView style={styles.container} >
                <View style={styles.header_menu_popup}>
                    <TouchableOpacity
                        ...
                        onPress={() => {
                            this.props.closeMenu();
                            // this.setState({headerMenuPopup: false})
                        }}>
                        <Svg
                            width={30}
                            height={30}
                    ...
                    <View style={styles.header_menu_popup_wrapper}>
                        <View style={styles.header_menu_popup_logo_nav_btn_wrapper}>
                            ...
                            <TouchableOpacity style={styles.header_menu_popup_logout_button} onPress={() => {this.logOut()}}>
                                ...
                                <View style={styles.header_menu_popup_logout_button_icon}>
                                    ...
                                    >
                                        <Path
                                            d="M12.797 16.734H1.266V1.266h11.53V.14H.142v17.718h12.656v-1.125z"
                                            fill="#fff"
                                        />
                                        <Path
                                            d="M6.75 8.438H5.625v1.124H6.75V8.438zM12.769 13.613L17.395 9 12.77 4.388l-.788.787 3.249 3.263H8.156v1.124h7.074l-3.249 3.263.788.788z"
                                            fill="#fff"
                                        />
                                    </Svg>
                                </View>
                        ...
                        <View style={styles.header_menu_popup_call_email_logo_wrapper}>
                            {/*<Button style={styles.header_menu_popup_call_btn} title='+7 (495) 984-21-01' onPress={ () => {this.pressCall()} }*/}
                            {/*/>*/}
                            ...
                            {/*<Button style={styles.header_menu_popup_email_btn} title='pilot@zis.ru' onPress={ () => {this.handlePress()} } />*/}
