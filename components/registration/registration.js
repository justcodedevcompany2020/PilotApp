...
export default class App extends Component {
    ...
    signUpHandler = () => {
        let {email,password, switchValue } = this.state;
        ...
        if ( email.length == 0 || password.length < 6  ) {
            ...
            if (email.length == 0) {
                this.setState({
                    email_error: true,
                    email_error_text: this.state.language.error_email,
                })
            } else {
                this.setState({
                    email_error: false,
            ...
            if (password.length < 6 ) {
                this.setState({
                    password_error: true,
                    password_error_text: this.state.language.password_must_be,
                })
            }  else {
                this.setState({
                    password_error: false,
            ...
            try {
                fetch(`https://apiv1.zis.ru/auth/register`, {
                    method: 'POST',
                    headers: {
                    ...
                    console.log({
                        login: email,
                        password: hash_password_result,}, 'register')
                 ...
                 if (response.hasOwnProperty('result')) {
                     ...
                     if (response.hasOwnProperty('description')) {
                         ...
                         if (response.description.en == 'Missing Required Fields') {
                             error_text = this.state.language.missing_fields_error
                         } else {
                             this.setState({
                                 registration_error: false,
                                 registration_error_text: ''
                          ...
                          if (response.description.en == 'Login already exists') {
                             error_text = this.state.language.login_already_exists
                         } else {
                              this.setState({
                                  registration_error: false,
                                  registration_error_text: ''
                         ...
                         this.setState({
                             ...
                             registration_error_text: error_text
                         })
        ...
        return (
            <SafeAreaView style={styles.container} >
                ...
                <View style={styles.registration_header}>
                    <View style={styles.registration_header_logo}>
                ...
                <ScrollView style={styles.registration_main_wrapper}>

                    {this.state.registration_error &&
                       <Text style={styles.error_text}>{this.state.registration_error_text}</Text>
                    }

                    <View style={[styles.registration_input_field_wrapper ]}>

                        <TextInput
                            style={[styles.registration_input_field]}
                    ...
                    <View style={[styles.registration_input_field_wrapper ]}>
                        ...
                        <TextInput
                            style={[styles.registration_input_field, {marginRight: 18, flex: 1}]}
                    ...
                    <TouchableOpacity style={styles.register_main_btn} onPress={() => {this.signUpHandler()}}>
                        <Text style={styles.register_main_btn_text}>{this.state.language.register}</Text>
                    </TouchableOpacity>
                    <View style={styles.registration_buttons_wrapper}>
                        ...
                        <TouchableOpacity style={styles.registration_btn} onPress={() => {this.redirectToPasswordRecovery()}}>
                            <Text style={styles.registration_btn_text}>{this.state.language.password_recovery}</Text>
                        </TouchableOpacity>
                        <TouchableOpacity
                ...
                {this.state.register_success_popup &&
                   <View style={styles.register_success_popup}>
                        <View style={styles.register_success_popup_wrapper}>
                            ...
                            <View style={styles.register_success_popup_icon}>
                             ...
                             <Text style={styles.register_success_popup_text}>{this.state.language.registered_successfully}</Text>
                            <View style={{paddingHorizontal: 30}}>
                                <TouchableOpacity style={styles.register_success_popup_login_btn} onPress={() => {this.redirectToLogin()}}>
                                    <Text style={styles.register_success_popup_login_btn_text}>{this.state.language.enter}</Text>
                                </TouchableOpacity>
                            </View>
...
const styles = StyleSheet.create({
    ...
    registration_input_field_wrapper: {
        marginBottom: 17,
    },
    register_main_btn: {
    ...
    register_main_btn_text: {
        fontSize: 16,
        fontWeight: '400',
        color: '#ffffff',
    },

    registration_buttons_wrapper: {
        flexDirection: 'row',
        justifyContent: 'flex-start',
        flexWrap: 'wrap',
        alignItems: 'center',
