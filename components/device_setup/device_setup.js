...
//
//         this.setState({
//             local_device_data: response
//         })
//
//         // try {
//         //     fetch(`http://192.168.0.1/pilot`, {
//         //         method: 'GET',
//         //         headers: {
...
//
//     confirmSetup = async () => {
//         let {wifiAccess, wifiPassword} = this.state;
...
//                                     <Text style={styles.new_device_has_been_found_info1}>
//
//
//                                         {this.state.local_device_data  ? this.state.language.new_device_has_been_found : this.state.language.new_device_has_been_notfound }
//                                     </Text>
...
//                                         <Text style={styles.device_info_detail}>ID: {this.state.local_device_data.ident}</Text>
//                                         <Text style={styles.device_info_detail}>{this.state.local_device_data.type}</Text>
//                                         <Text style={styles.device_info_detail}>HW {this.state.local_device_data.hw_version}  SW {this.state.local_device_data.sw_version}</Text>
...
//                                             placeholderTextColor='#4A4A4A'
//                                         />
//                                         <TouchableOpacity style={styles.confirm_new_device_btn} onPress={() => {this.confirmSetup()}}>
    ...
    confirmSetup = async () => {
        ...
        try {
            fetch(`http://192.168.0.1/setup`, {
                ...
                body: JSON.stringify({
                    req: 'wifi_config',
                    //   wifi_access_point: wifiAccess,
                    //wifi_password: wifiPassword,
                    //account_login: userLogin
                    ssid: wifiAccess,
