...
const en = {
    ...
    initial_setup: 'In the side menu of the application, click “Initial setup” or in the search section, click on the “Manual device setup” button or open the page http://192.168.1.1 in a web browser.',
    ...
    test: 'Test',
    read: 'Read',
    delete_account_title: 'Are you sure you want to disable your account?',
    impulse_surges_limit_title: 'Surge limit (V)',
    no_internet: 'No Internet Connection',
    local_setup: 'Local Setup',
    remove_filter: 'Clear search by мак',
    device_not_found: 'Devices are not discovered',
    v: 'А',
    voltage_n: 'V',

    not_selected: 'Not selected',

    protection_undervoltage: 'Undervoltage triggered',
    protection_overvoltage: 'Uppervoltage triggered',
    protection_overcurrent: 'Current triggered',

    times: 'times',
    protections_title: 'Protections',
    no_grafik_data: 'There is no data to display for the selected period.',
    total: 'Total',
...
const ru = {
    ...
    initial_setup: 'В боковом меню приложения нажмите “Первичная настройка” или в разделе поиска, нажмите кнопку “Ручная настройка устройства” или откройте в веб браузере страницу http://192.168.1.1',
    ...
    wifi_available: 'Если сеть PILOT_XXXX снова доступна для подключения, то повторите действия, начиная с шага 2, Удостоверьтесь в том что вы указываете правильные имя Wi-Fi сети и пароль.',
    ...
    not_device: 'Если в списке нет нужного устройства. то введите заводской номер в формате AAAA:BBBB:CCCC который напечатан на коробке и на устройстве.',
    new_device_is_ready: 'Новое устройство готово к работе. Рекомендуется задать имя новому устройству.',
    not_listed_device: 'Если устройства нет в списке, выполните сброс устройства. Для этого удержите кнопку на корпусе устройства в течении 10 секунд, и повторите шаги по первичной настройке.',
    ...
    protection_upper_voltage_title: 'Граница повышеного напряжения (В)',
    protection_lower_voltage_title: 'Граница пониженого напряжения (В)',
    ...
    current_protection_title: 'Защита по силе тока (А)',
    current_protection_delay: 'Задержка отключения по силе тока (сек)',
    ...
    power_outages: 'Отсутствие электропитания',
    impulse_surges: 'Импульсные скачки',
    stop_now: 'Остановить сейчас',
    total_duration: 'Общая продолжительность',
    peak_value: 'Максимальное значение',
    limit: 'Ограничение',
    day: 'День',
    week: 'Неделя',
    month: 'Месяц',
    ...
    refrigerator: 'Холодильник / Кондиционер',
    other_home_appliance: 'Другая бытовая техника',
    manual_setup: 'Ручная настройка',


    protection_upper_voltage_title2: 'Защита при повышении напряжения (В)',
    upper_voltage_sec2: 'Задержка отключения при повышенном напряжении (сек)',
    protection_lower_voltage_title2: 'Защита при пониженнии напряжения (В)',
    lower_voltage_delay_sec2: 'Задержка отключения при пониженнии напряжения (сек)',
    account: 'аккаунтов',
    test: 'Тест',
    read: 'Читать',
    delete_account_title: 'Вы уверены, что хотите отключить аккаунт?',
    impulse_surges_limit_title: 'Граница импульсных перенапряжений (В)',
    no_internet: 'Отсутствует подключение к интернету',

    local_setup: 'Локальная настройка',
    remove_filter: 'Очистить поиск по mac',
    device_not_found: 'Устройства автоматически не обнаружены',
    v: 'А',
    voltage_n: 'В',
    ...
    protection_undervoltage: 'Откл. по пониженному',
    protection_overvoltage: 'Откл. по повышенному',
